...
contract  Ownership {
    ...
    event TransferOwnership(address indexed _from, address indexed _to);
     ...
     function changeOwner(address _to) public{
         require (msg.sender==contractOwner,"Only Owner of the contract can execute");
         newOwner= _to;
     }
     function acceptOwner() public{
          require (msg.sender==newOwner,"Only newowner can call it");
...
contract  MyERC20 is ERC20_STD,Ownership {
    ...
    function approve(address _spender, uint256 _value) public override returns (bool success){
        require (tokenBalances[msg.sender]>=_value,"Infufficient Token");
